...
export default function AdminReports() {
  ...
  const generateReport = async () => {
    ...
    const res = await apiRequest(`/admin/reports?${query}`);
    if (res.success) {
  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-white">System Reports & Export</h1>
          <p className="text-xs text-gray-400 font-mono font-medium">Generate institutional reports and export to Excel, CSV, or PDF</p>
        </div>
